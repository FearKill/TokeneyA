...
public class MainActivity extends Activity implements RewardedVideoAdListener {
    private static final String AD_UNIT_ID = "ca-app-pub-1305764548928835/8117832517";
    private static final String APP_ID = "ca-app-pub-1305764548928835~3865642602";
    ...
    private void addCoins(int coins) {
        coinCount += coins;
        coinCountText.setText("Tokens: " + coinCount);
    }
    ...
    public void openActivity2() {
        Intent intent = new Intent(this, RedeemTokens.class);
